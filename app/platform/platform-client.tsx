...
export function PlatformConsole({ adminName }: { adminName: string }) {
    ...
    <div className="mx-auto max-w-6xl p-4 sm:p-8">
      <header className="flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <h1 className="mt-1 text-3xl">Semua toko</h1>
      ...
      <div className="mt-6 space-y-4">
        {stores.map((store) => (
          <article key={store.id} className="rounded-xl border bg-white p-5">
                  ...
                  {store.domains.map((domain) => (
                    ...
                    >
                      ...
                      <button
                        ...
                        onClick={() => {
                          if (
                            confirm(`Lepas ${domain.host} dari ${store.name}?`)
                          )
                            void run(
                              () =>
                                api(
                  ...
                  <button
                    ...
                    onClick={() =>
                      void run(
                        ...
                        (ok) =>
                          ok &&
                          setDomainInput({ ...domainInput, [store.id]: '' }),
                      )
                    }
                  >
                    Tambah
