...
export default function ProductDetailClient({
  ...
  async function addToCart() {
    ...
    setMessage(
      'Produk ditambahkan ke keranjang. Buka halaman toko untuk melanjutkan checkout.',
    );
  }
  ...
  return (
    <main className="min-h-screen bg-[#f7f4ec] text-[#17251c]">
      ...
      <div className="mx-auto max-w-6xl px-4 py-6 sm:px-6 sm:py-10">
        <nav className="mb-5 text-xs text-[#6f7b72]">
          <a href="/">Beranda</a> · <span>{product.category}</span> ·{' '}
          <b>{product.name}</b>
        </nav>
        <section className="overflow-hidden rounded-3xl border bg-white shadow-sm">
          <div className="grid md:grid-cols-2">
            ...
            <div className="p-5 sm:p-8">
              <p className="text-xs font-bold uppercase tracking-wider text-[#637168]">
              ...
              {(product.material ||
                ...
                product.production_estimate ||
                product.size_guide) && (
                <div className="mt-5 space-y-4 rounded-2xl bg-[#f3f6f3] p-4 text-sm">
                  {product.material && (
                    <div>
                      <b>Bahan</b>
              ...
              <div className="mt-4 grid gap-3 sm:grid-cols-2">
                {reviews.map((review) => (
                  ...
                  >
                    ...
                    <p className="mt-2 text-sm text-[#59665d]">{review.body}</p>
                  </article>
                ))}
              </div>
            ) : (
        ...
        {related.length > 0 && (
          <section className="mt-8">
            <h2 className="font-serif text-2xl font-bold">Produk serupa</h2>
