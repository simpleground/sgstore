...
const api = moduleFrom('app/api/admin/products/bulk/route.ts', {'next/server':{NextResponse:{json:(d,o)=>new Response(JSON.stringify(d),o)}}, '@/app/chatgpt-auth':{getChatGPTUser:async()=>({userId:'admin'})}, '@/db':{getD1:()=>db}, '@/lib/catalog-normalize':moduleFrom('lib/catalog-normalize.ts')});
