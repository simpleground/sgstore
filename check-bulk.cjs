...
const api = moduleFrom('app/api/admin/products/bulk/route.ts', {'next/server':{NextResponse:{json:(d,o)=>new Response(JSON.stringify(d),o)}}, '@/lib/admin-auth':{isAdmin:async()=>true}, '@/db':{getD1:()=>db}, '@/lib/catalog-normalize':moduleFrom('lib/catalog-normalize.ts')});
